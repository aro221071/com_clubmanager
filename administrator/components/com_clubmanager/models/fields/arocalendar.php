 ...
 * @since       11.1
 */
class JFormFieldAroCalendar extends JFormField
{
	/**
	 * The form field type.
	 *
	...
	public function setup(SimpleXMLElement $element, $value, $group = null)
	{
		...
		if ($return)
		{
			...
			$this->format    = (string) $this->element['format'] ? (string) $this->element['format'] : '%d.%m.%Y';
	...
	protected function getInput()
	{
		...
		switch (strtoupper($this->filter))
		{
          ...
          $this->value = $date->format('d.m.Y H:i:s', true, false);
				}
    ...
    var_dump($format);
    */
    if (strlen($this->value) == 0 || $this->value == '0000-00-00')
    {
      $this->value = '';      
    }
