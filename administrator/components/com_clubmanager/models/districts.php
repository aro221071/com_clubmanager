 ...
 */
class ClubmanagerModelDistricts extends JModelList {
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__clubmanager_district` AS a');
		...
		$query->select('#__clubmanager_country_1861332.name AS countries_name_1861332');
		$query->join('LEFT', '#__clubmanager_country AS #__clubmanager_country_1861332 ON #__clubmanager_country_1861332.id = a.country');
		// Join over the foreign key 'county'
		$query->select('#__clubmanager_county_1861333.name AS counties_name_1861333');
		$query->join('LEFT', '#__clubmanager_county AS #__clubmanager_county_1861333 ON #__clubmanager_county_1861333.id = a.county');
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.name LIKE '.$search.'  OR  a.shortname LIKE '.$search.'  OR  a.country LIKE '.$search.'  OR  a.county LIKE '.$search.'  OR  a.default LIKE '.$search.'  OR  a.comment LIKE '.$search.' )');
            }
        }
