 ...
 * city Table class
 */
class ClubmanagerTablecity extends JTable
{
	...
	{
		parent::__construct('#__clubmanager_city', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_clubmanager.city.' . $array['id']))
		{
			$actions         = JFactory::getACL()->getActions('com_clubmanager', 'city');
			$default_actions = JFactory::getACL()->getAssetRules('com_clubmanager.city.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_clubmanager.city.' . (int) $this->$k;
	}
