 ...
 */
class ClubmanagerTabledistrict extends JTable
{
	...
	{
		parent::__construct('#__clubmanager_district', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_clubmanager.district.' . $array['id']))
		{
			$actions         = JFactory::getACL()->getActions('com_clubmanager', 'district');
			$default_actions = JFactory::getACL()->getAssetRules('com_clubmanager.district.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_clubmanager.district.' . (int) $this->$k;
	}
