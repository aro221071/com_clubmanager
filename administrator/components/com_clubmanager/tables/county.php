 ...
 * county Table class
 */
class ClubmanagerTablecounty extends JTable
{
	...
	{
		parent::__construct('#__clubmanager_county', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_clubmanager.county.' . $array['id']))
		{
			$actions         = JFactory::getACL()->getActions('com_clubmanager', 'county');
			$default_actions = JFactory::getACL()->getAssetRules('com_clubmanager.county.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_clubmanager.county.' . (int) $this->$k;
	}
