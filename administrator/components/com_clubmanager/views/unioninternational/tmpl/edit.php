...
<script type="text/javascript">
    ...
    {
        if (task == 'unioninternational.cancel') {
            Joomla.submitform(task, document.getElementById('unioninternational-form'));
        }
        else {
            
            if (task != 'unioninternational.cancel' && document.formvalidator.isValid(document.id('unioninternational-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_clubmanager&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="unioninternational-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_CLUBMANAGER_TITLE_UNIONINTERNATIONAL', true)); ?>
        <div class="row-fluid">
