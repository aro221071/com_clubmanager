...
<script type="text/javascript">
    ...
    {
        if (task == 'postnewsletter.cancel') {
            Joomla.submitform(task, document.getElementById('postnewsletter-form'));
        }
        else {
            ...
            if (task != 'postnewsletter.cancel' && document.formvalidator.isValid(document.id('postnewsletter-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_clubmanager&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="postnewsletter-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_CLUBMANAGER_TITLE_POSTNEWSLETTER', true)); ?>
        <div class="row-fluid">
