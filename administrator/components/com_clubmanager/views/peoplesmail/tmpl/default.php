...
<form action="<?php echo JRoute::_('index.php?option=com_clubmanager&view=peoplesmail'); ?>" method="post" name="adminForm" id="adminForm">
  ...
  <?php endif;?>
    ...
    <table class="table table-striped" id="peopleList">
      <thead>
        ...
        <th class='left'>
        <?php echo JHtml::_('grid.sort',  'COM_CLUBMANAGER_PEOPLES_EMAIL2', 'a.email2', $listDirn, $listOrder); ?>
        </th>
        <th class='left'>
        <?php echo JHtml::_('grid.sort',  'COM_CLUBMANAGER_PEOPLES_EMAIL3', 'a.email3', $listDirn, $listOrder); ?>
        </th>
      ...
      <?php foreach ($this->items as $i => $item) :
        ...
        <td><?php echo $item->email2; ?>     </td>
        <td><?php echo $item->email3; ?>     </td>
