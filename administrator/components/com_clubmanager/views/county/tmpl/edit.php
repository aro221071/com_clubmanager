...
<script type="text/javascript">
    ...
    {
        if (task == 'county.cancel') {
            Joomla.submitform(task, document.getElementById('county-form'));
        }
        else {
            
            if (task != 'county.cancel' && document.formvalidator.isValid(document.id('county-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_clubmanager&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="county-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_CLUBMANAGER_TITLE_COUNTY', true)); ?>
        <div class="row-fluid">
