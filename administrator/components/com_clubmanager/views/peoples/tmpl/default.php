<?php
  ...
  if ($saveOrder)
  {
    $saveOrderingUrl = 'index.php?option=com_clubmanager&task=peoples.saveOrderAjax&tmpl=component';
      ...
      <?php foreach ($this->items as $i => $item) :
        ...
        <tr class="row<?php echo $i % 2; ?>">
          ...
          <td>
            ...
            ?>
            <?php if ($canEdit) : ?>
              <a href="<?php echo JRoute::_('index.php?option=com_clubmanager&task=people.edit&id='.(int) $item->id); ?>">
          ...
          <td>
            <img src="<?php echo "/administrator/components/com_clubmanager/images/people/".$item->picture; ?>"  alt="" style="height: 30px;" />
          </td>
          
          <td>
            <?php 
              echo $item->salutation; 
            ?> 
          </td>
        ...
        <td>
          <?php
            if ($item->birthdate == "0000-00-00" || $item->birthdate == "" || $item->birthdate == "NULL" || $item->birthdate == "null")
            {
              echo "&nbsp";
            }
            else 
            {
              echo ClubmanagerHelper::aroFormatDate($item->birthdate);
            }
          ?>
        </td>
        <td><?php echo $item->memberclub; ?> </td>
        <td><?php echo $item->memberno; ?>   </td>
        <td><?php echo $item->phone1; ?>     </td>
        <td><?php echo $item->email1; ?>     </td>
        <td><?php echo $item->role; ?>       </td>
        <td><?php echo $item->newsletter; ?> </td>
