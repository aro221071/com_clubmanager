 ...
 */
class ClubmanagerViewRoles extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        ClubmanagerHelper::addSubmenu('roles');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_CLUBMANAGER_TITLE_ROLES'), 'roles.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_clubmanager&view=roles');
	...
	protected function getSortFields()
	{
		...
		'a.name' => JText::_('COM_CLUBMANAGER_ROLES_NAME'),
		'a.shortname' => JText::_('COM_CLUBMANAGER_ROLES_SHORTNAME'),
		'a.default' => JText::_('COM_CLUBMANAGER_ROLES_DEFAULT'),
		'a.ordering' => JText::_('JGRID_HEADING_ORDERING'),
		'a.state' => JText::_('JSTATUS'),
		'a.comment' => JText::_('COM_CLUBMANAGER_ROLES_COMMENT'),
		);
	}
