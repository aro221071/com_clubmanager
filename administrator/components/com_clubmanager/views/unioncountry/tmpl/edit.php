...
<script type="text/javascript">
    ...
    {
        if (task == 'unioncountry.cancel') {
            Joomla.submitform(task, document.getElementById('unioncountry-form'));
        }
        else {
            
            if (task != 'unioncountry.cancel' && document.formvalidator.isValid(document.id('unioncountry-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_clubmanager&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="unioncountry-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_CLUBMANAGER_TITLE_UNIONCOUNTRY', true)); ?>
        <div class="row-fluid">
