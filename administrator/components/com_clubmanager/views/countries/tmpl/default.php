...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_clubmanager&task=countries.saveOrderAjax&tmpl=component';
...
<?php endif;?>
		...
		<table class="table table-striped" id="countryList">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_clubmanager&task=country.edit&id='.(int) $item->id); ?>">
