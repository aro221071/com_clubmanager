 ...
 */
class ClubmanagerViewCountries extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        ClubmanagerHelper::addSubmenu('countries');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_CLUBMANAGER_TITLE_COUNTRIES'), 'countries.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_clubmanager&view=countries');
	...
	protected function getSortFields()
	{
		...
		'a.name' => JText::_('COM_CLUBMANAGER_COUNTRIES_NAME'),
		'a.code2' => JText::_('COM_CLUBMANAGER_COUNTRIES_CODE2'),
		'a.code3' => JText::_('COM_CLUBMANAGER_COUNTRIES_CODE3'),
		'a.phonecode' => JText::_('COM_CLUBMANAGER_COUNTRIES_PHONECODE'),
		'a.domain' => JText::_('COM_CLUBMANAGER_COUNTRIES_DOMAIN'),
		'a.comment' => JText::_('COM_CLUBMANAGER_COUNTRIES_COMMENT'),
		'a.ordering' => JText::_('JGRID_HEADING_ORDERING'),
		'a.state' => JText::_('JSTATUS'),
		'a.default' => JText::_('COM_CLUBMANAGER_COUNTRIES_DEFAULT'),
		);
	}
