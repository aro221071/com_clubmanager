...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_clubmanager&task=clubs.saveOrderAjax&tmpl=component';
...
<?php endif;?>
		...
		<table class="table table-striped" id="clubList">
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'clubs.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_clubmanager&task=club.edit&id='.(int) $item->id); ?>">
				...
				<td>
					<?php echo TextButNotNull($item->postalcode); ?>
				</td>
				<td>
					<?php echo TextButNotNull($item->city); ?>
				</td>
				<td>
					<?php echo TextButNotNull($item->county); ?>
				</td>
				<td>
					<?php echo TextButNotNull($item->district); ?>
				</td>
				<td>
				...
				<td>
					<?php echo TextButNotNull($item->uniondistrict); ?>
				</td>
                <?php if (isset($this->items[0]->id)): ?>
