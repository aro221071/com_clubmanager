 ...
 */
class ClubmanagerViewCitys extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        ClubmanagerHelper::addSubmenu('citys');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_CLUBMANAGER_TITLE_CITYS'), 'citys.png');
        ...
        if ($canDo->get('core.edit.state')) {
            ...
            if (isset($this->items[0]->state)) {
                ...
                JToolBarHelper::custom('citys.publish', 'publish.png', 'publish_f2.png', 'JTOOLBAR_PUBLISH', true);
                JToolBarHelper::custom('citys.unpublish', 'unpublish.png', 'unpublish_f2.png', 'JTOOLBAR_UNPUBLISH', true);
            } else if (isset($this->items[0])) {
                //If this component does not use state then show a direct delete button as we can not trash
                JToolBarHelper::deleteList('', 'citys.delete', 'JTOOLBAR_DELETE');
            }

            if (isset($this->items[0]->state)) {
                JToolBarHelper::divider();
                JToolBarHelper::archiveList('citys.archive', 'JTOOLBAR_ARCHIVE');
            }
            if (isset($this->items[0]->checked_out)) {
                JToolBarHelper::custom('citys.checkin', 'checkin.png', 'checkin_f2.png', 'JTOOLBAR_CHECKIN', true);
            }
        }
        ...
        if (isset($this->items[0]->state)) {
            if ($state->get('filter.state') == -2 && $canDo->get('core.delete')) {
                JToolBarHelper::deleteList('', 'citys.delete', 'JTOOLBAR_EMPTY_TRASH');
                JToolBarHelper::divider();
            } else if ($canDo->get('core.edit.state')) {
                JToolBarHelper::trash('citys.trash', 'JTOOLBAR_TRASH');
                JToolBarHelper::divider();
            }
        }
        ...
        JHtmlSidebar::setAction('index.php?option=com_clubmanager&view=citys');
        ...
        $form = JForm::getInstance('com_clubmanager.city', 'city');
	...
	protected function getSortFields()
	{
		...
		'a.name' => JText::_('COM_CLUBMANAGER_CITYS_NAME'),
		'a.postalcode' => JText::_('COM_CLUBMANAGER_CITYS_POSTALCODE'),
		'a.district' => JText::_('COM_CLUBMANAGER_CITYS_DISTRICT'),
		'a.county' => JText::_('COM_CLUBMANAGER_CITYS_COUNTY'),
		'a.country' => JText::_('COM_CLUBMANAGER_CITYS_COUNTRY'),
		'a.default' => JText::_('COM_CLUBMANAGER_CITYS_DEFAULT'),
		'a.ordering' => JText::_('JGRID_HEADING_ORDERING'),
		'a.state' => JText::_('JSTATUS'),
		'a.comment' => JText::_('COM_CLUBMANAGER_CITYS_COMMENT'),
		);
	}
