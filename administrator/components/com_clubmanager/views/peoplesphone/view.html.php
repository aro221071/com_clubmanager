 ...
 */
class ClubmanagerViewPeoplesphone extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_CLUBMANAGER_TITLE_PEOPLESPHONE'), 'peoples.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_clubmanager&view=peoplesphone');
