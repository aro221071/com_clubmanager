 ...
 * Clubmanager model.
 */
class ClubmanagerModelCity extends JModelItem {
    ...
    protected function populateState() {
        ...
        if (JFactory::getApplication()->input->get('layout') == 'edit') {
            $id = JFactory::getApplication()->getUserState('com_clubmanager.edit.city.id');
        } else {
            $id = JFactory::getApplication()->input->get('id');
            JFactory::getApplication()->setUserState('com_clubmanager.edit.city.id', $id);
        }
        ...
        if (isset($params_array['item_id'])) {
            $this->setState('city.id', $params_array['item_id']);
        }
