 ...
 * Clubmanager model.
 */
class ClubmanagerModelEmailnewsletter extends JModelItem {
    ...
    protected function populateState() {
        ...
        if (JFactory::getApplication()->input->get('layout') == 'edit') {
            $id = JFactory::getApplication()->getUserState('com_clubmanager.edit.emailnewsletter.id');
        } else {
            $id = JFactory::getApplication()->input->get('id');
            JFactory::getApplication()->setUserState('com_clubmanager.edit.emailnewsletter.id', $id);
        }
        $this->setState('emailnewsletter.id', $id);

        // Load the parameters.
        $params = $app->getParams();
        $params_array = $params->toArray();
        if (isset($params_array['item_id'])) {
            $this->setState('emailnewsletter.id', $params_array['item_id']);
        }
    ...
    public function &getData($id = null) {
        if ($this->_item === null) {
            ...
            if (empty($id)) {
                $id = $this->getState('emailnewsletter.id');
            }
    ...
    public function getTable($type = 'Emailnewsletter', $prefix = 'ClubmanagerTable', $config = array()) {
    ...
    public function checkin($id = null) {
        // Get the id.
        $id = (!empty($id)) ? $id : (int) $this->getState('emailnewsletter.id');
