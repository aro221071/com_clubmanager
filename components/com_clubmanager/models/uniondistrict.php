 ...
 * Clubmanager model.
 */
class ClubmanagerModelUniondistrict extends JModelItem {
    ...
    protected function populateState() {
        ...
        if (JFactory::getApplication()->input->get('layout') == 'edit') {
            $id = JFactory::getApplication()->getUserState('com_clubmanager.edit.uniondistrict.id');
        } else {
            $id = JFactory::getApplication()->input->get('id');
            JFactory::getApplication()->setUserState('com_clubmanager.edit.uniondistrict.id', $id);
        }
        $this->setState('uniondistrict.id', $id);

        // Load the parameters.
        $params = $app->getParams();
        $params_array = $params->toArray();
        if (isset($params_array['item_id'])) {
            $this->setState('uniondistrict.id', $params_array['item_id']);
        }
    ...
    public function &getData($id = null) {
        if ($this->_item === null) {
            ...
            if (empty($id)) {
                $id = $this->getState('uniondistrict.id');
            }
    ...
    public function getTable($type = 'Uniondistrict', $prefix = 'ClubmanagerTable', $config = array()) {
    ...
    public function checkin($id = null) {
        // Get the id.
        $id = (!empty($id)) ? $id : (int) $this->getState('uniondistrict.id');
