 ...
 * Clubmanager model.
 */
class ClubmanagerModelPostnewsletter extends JModelItem {
    ...
    protected function populateState() {
        ...
        if (JFactory::getApplication()->input->get('layout') == 'edit') {
            $id = JFactory::getApplication()->getUserState('com_clubmanager.edit.postnewsletter.id');
        } else {
            $id = JFactory::getApplication()->input->get('id');
            JFactory::getApplication()->setUserState('com_clubmanager.edit.postnewsletter.id', $id);
        }
        $this->setState('postnewsletter.id', $id);

        // Load the parameters.
        $params = $app->getParams();
        $params_array = $params->toArray();
        if (isset($params_array['item_id'])) {
            $this->setState('postnewsletter.id', $params_array['item_id']);
        }
    ...
    public function &getData($id = null) {
        if ($this->_item === null) {
            ...
            if (empty($id)) {
                $id = $this->getState('postnewsletter.id');
            }
    ...
    public function getTable($type = 'Postnewsletter', $prefix = 'ClubmanagerTable', $config = array()) {
    ...
    public function checkin($id = null) {
        // Get the id.
        $id = (!empty($id)) ? $id : (int) $this->getState('postnewsletter.id');
