 ...
 * Clubmanager model.
 */
class ClubmanagerModelDistrict extends JModelItem {
    ...
    protected function populateState() {
        ...
        if (JFactory::getApplication()->input->get('layout') == 'edit') {
            $id = JFactory::getApplication()->getUserState('com_clubmanager.edit.district.id');
        } else {
            $id = JFactory::getApplication()->input->get('id');
            JFactory::getApplication()->setUserState('com_clubmanager.edit.district.id', $id);
        }
        $this->setState('district.id', $id);

        // Load the parameters.
        $params = $app->getParams();
        $params_array = $params->toArray();
        if (isset($params_array['item_id'])) {
            $this->setState('district.id', $params_array['item_id']);
        }
    ...
    public function getTable($type = 'District', $prefix = 'ClubmanagerTable', $config = array()) {
    ...
    public function checkin($id = null) {
        // Get the id.
        $id = (!empty($id)) ? $id : (int) $this->getState('district.id');
